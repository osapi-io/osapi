...
Add a Docusaurus page documenting the feature roadmap organized by
priority tiers. This gives users and contributors a clear picture of
where OSAPI is headed and what's needed to be a legitimate OS management
appliance.
...
Link to contributing guide and explain how to pick up a feature from
the roadmap.

## Notes

- Keep the page updated as features are implemented (move from roadmap
