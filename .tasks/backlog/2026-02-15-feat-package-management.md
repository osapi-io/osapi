...
Add package management endpoints for querying and managing installed
packages. Essential for maintaining system software and security patches.
...
- Implementations: `apt_provider.go` (Debian/Ubuntu),
  `yum_provider.go` (RHEL/CentOS)
- Return type: `PackageInfo` with name, version, description, installed
  size, status
