...
Add a comprehensive system facts endpoint. Ansible's `setup` module
(fact gathering) is run automatically on every play — it collects
hardware, OS, network, and storage facts into a single structured
document. This is invaluable for inventory and fleet management.
