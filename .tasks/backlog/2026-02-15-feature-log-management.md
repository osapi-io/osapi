---
title: "Feature: Log viewing and management"
status: backlog
created: 2026-02-15
updated: 2026-02-15
---
...
Add log viewing endpoints. Appliance operators need to inspect system
and service logs for troubleshooting without SSH access.
...
- Return type: `LogEntry` with timestamp, unit, priority, message,
  PID, hostname
