...
Add the ability to set the system hostname. Currently only
`system.hostname.get` exists. Ansible's `hostname` module is heavily
used for provisioning. This is a small but important CRUD gap.
