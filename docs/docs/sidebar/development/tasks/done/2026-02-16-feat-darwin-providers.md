...
gopsutil data for system providers (host, disk, mem, load) and mock data for DNS
and ping since they depend on platform-specific tooling.
...
Implemented 24 new Darwin provider files, modified 7 existing files. All tests
pass, 0 lint issues. Committed on `feat/darwin-providers` branch.
