...
- `internal/provider/system/host/darwin*.go` — Darwin host provider (7 files)
  with GetHostname, GetUptime, GetOSInfo using gopsutil.
- `internal/provider/system/disk/darwin*.go` — Darwin disk provider (3 files)
  with GetLocalUsageStats filtering for apfs/hfs filesystems.
- `internal/provider/system/mem/darwin*.go` — Darwin memory provider (3 files)
  with GetStats using gopsutil.
- `internal/provider/system/load/darwin*.go` — Darwin load provider (3 files)
