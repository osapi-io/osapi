...
Add firewall rule management endpoints. An appliance needs to control network
access for security hardening.
...
- Rule model: direction (in/out), action (allow/deny), protocol (tcp/udp/any),
