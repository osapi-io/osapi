...
Add scheduled task management. Appliances need recurring maintenance operations
(log rotation, backups, health checks) managed via API.
...
- Could also integrate with the NATS job system for scheduled job submission
