...
accepted or rejected by an administrator. This command rejects a
pending agent, preventing it from joining the fleet. The agent's
enrollment entry is removed from the pending queue.
