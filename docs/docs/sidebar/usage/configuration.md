...
controller:
  ...
  api:
    ...
    security:
      ...
      #              health:read, audit:read, command:execute,
      #              command:shell, file:read, file:write, docker:read,
      #              docker:write, docker:execute, cron:read, cron:write,
      #              sysctl:read, sysctl:write, ntp:read, ntp:write,
      #              timezone:read, timezone:write, power:execute,
      #              process:read, process:execute, user:read, user:write,
      #              package:read, package:write, log:read,
      #              certificate:read, certificate:write, service:read,
      #              service:write
      # roles:
      #   ops:
      #     permissions:
