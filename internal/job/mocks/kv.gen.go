...
// Source: github.com/nats-io/nats.go (interfaces: KeyValue,KeyValueEntry,KeyWatcher)
...
func (mr *MockKeyWatcherMockRecorder) Context() *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockKeyWatcher) Updates() <-chan nats.KeyValueEntry {
	...
	ret0, _ := ret[0].(<-chan nats.KeyValueEntry)
	return ret0
}
